...
export async function ocr(body, apiKey) {
  ...
  const result = await callGemini(apiKey, {
    contents: [{
      parts: [
        {
          text: 'Please extract all text from this exam question paper. IMPORTANT: You MUST prefix EVERY question number with the exact word "Question ", like "Question 1:", "Question 2:", etc. '
              + 'Format the output cleanly, identifying sub-questions (a, b, c), and any instructions. '
